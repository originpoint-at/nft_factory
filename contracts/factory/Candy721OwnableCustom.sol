...
contract Candy721OwnableCustom is ERC721Enumerable, Ownable {
    //    struct Trait {
    //        string display_type;
    //        string trait_type;
    //        string trait_value;
    ...
    function mint(address to, uint256 tokenId, string calldata image, string calldata traits) public payable {
        bool success;
        ...
        // it requires to != address(0) && require !_exists(tokenId);
        _mint(to, tokenId);
